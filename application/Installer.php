 ...
 * @version 	$Id: Installer.php 4826 2010-08-24 07:32:20Z mehrab $
 * @since 		2.0.1
 */
...
class Installer extends Zend_Application_Bootstrap_Bootstrap 
{
	...
	protected function _initView()
	{
		...
		$view->addHelperPath(AMAN_APP_DIR . DS . 'modules' . DS . 'core' . DS . 'views' . DS . 'helpers', 'Core_View_Helper');
		 ...
		 */
		Zend_Layout::startMvc(array('layoutPath' => AMAN_APP_DIR . DS . 'templates' . DS . 'admin' . DS . 'layouts'));
