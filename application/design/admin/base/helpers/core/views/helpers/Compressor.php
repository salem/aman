 ...
 * @version 	$Id: Compressor.php 4366 2010-08-05 17:23:31Z mehrab $
 * @since		2.0.6
 */
...
class Core_View_Helper_Compressor extends Zend_View_Helper_Abstract 
{
	...
	public function compressor($type = 'js', $prefix = 'head')
	{
		 ...
		 */
		$cacheDir = AMAN_TEMP_DIR . DS . 'cache' . DS . $type;
			...
			switch ($type) {
				case 'css':
					foreach ($files as $index => $f) {
						 ...
						 * - jQueryUI theme (/js/jquery.ui/themes/base/jquery.ui.theme.css)
						 */
