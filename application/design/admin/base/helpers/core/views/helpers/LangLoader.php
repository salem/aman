 ...
 * @version 	$Id: LangLoader.php 3971 2010-07-25 10:26:42Z mehrab $
 * @since		1.0.0
 */
...
class Core_View_Helper_LangLoader extends Zend_View_Helper_Abstract 
{
	public function langLoader($module) 
	{
		...
		$dir = AMAN_APP_DIR . DS . 'modules' . DS . $module . DS . 'languages';
		if (is_dir($dir)) {
			/**
         ...
         */
        $widgetDir = AMAN_APP_DIR . DS . 'modules' . DS . $module . DS . 'widgets';
        if (is_dir($widgetDir)) {
