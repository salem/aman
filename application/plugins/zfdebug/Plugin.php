 ...
 * @version 	$Id: Plugin.php 4825 2010-08-24 07:18:31Z mehrab $
 * @since		1.0.0
 */

class Plugins_ZFDebug_Plugin extends Aman_Controller_Plugin 
{
	/**
	 * ZFDebug instance
	 * 
	...
	public function __construct() 
	{
		...
		$options = array(
    		...
    		'plugins' 	  => array(
    			'Variables',
				'Html',
				'Database' => array('adapter' => Aman_Db_Connection::factory()->getSlaveConnection()), 
				'File' 	   => array('base_path' => AMAN_ROOT_DIR), 
				'Memory',
				'Time',
				'Registry',
				'Exception',
