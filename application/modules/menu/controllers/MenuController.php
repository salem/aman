 ...
 * @version 	$Id: MenuController.php 4930 2010-08-25 03:38:40Z mehrab $
 * @since		2.0.2
 */
...
class Menu_MenuController extends Zend_Controller_Action 
{
	...
	public function buildAction() 
	{
		...
		$menuDao = Aman_Model_Dao_Factory::getInstance()->setModule('menu')->getMenuDao();
		...
		if ($request->isPost()) {
			 ...
			 */
			if ($items != '') {
				$itemDao = Aman_Model_Dao_Factory::getInstance()->setModule('menu')->getItemDao();
	...
	public function listAction() 
	{
		 ...
		 * Paginator
		 */
		$paginator = new Zend_Paginator(new Aman_Utility_PaginatorAdapter($menus, $numMenus));
