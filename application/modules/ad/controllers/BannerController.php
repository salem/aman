 ...
 * @version 	$Id: BannerController.php 4534 2010-08-12 09:50:52Z mehrab $
 * @since		1.0.0
 */
...
class Ad_BannerController extends Zend_Controller_Action 
{
	...
	public function activateAction()
	{
		...
		if ($request->isPost()) {
			...
			$bannerDao = Aman_Model_Dao_Factory::getInstance()->setModule('ad')->getBannerDao();
	...
	public function addAction() 
	{
		...
		$zoneDao 	   = Aman_Model_Dao_Factory::getInstance()->setModule('ad')->getZoneDao();
		$clientDao 	   = Aman_Model_Dao_Factory::getInstance()->setModule('ad')->getClientDao();
		$bannerDao 	   = Aman_Model_Dao_Factory::getInstance()->setModule('ad')->getBannerDao();
		$bannerPageDao = Aman_Model_Dao_Factory::getInstance()->setModule('ad')->getBannerPageAssocDao();
	...
	public function listAction()
	{
		 ...
		 * Paginator
		 */
		$paginator = new Zend_Paginator(new Aman_Utility_PaginatorAdapter($banners, $numBanners));
