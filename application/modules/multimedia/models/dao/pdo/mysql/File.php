 ...
 * @version 	$Id: File.php 5339 2010-09-07 08:38:12Z mehrab $
 * @since		2.0.5
 */

class Multimedia_Models_Dao_Pdo_Mysql_File extends Aman_Model_Dao
	implements Multimedia_Models_Interface_File
{
	...
	public function updateDescription($fileId, $title, $description = null) 
	{
		...
		if (null != $title) {
			$data['title'] = $title;
			$data['slug']  = Aman_Utility_String::removeSign($title, '-', true);
		}
		if (null != $description) {
