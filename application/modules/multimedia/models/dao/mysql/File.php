 ...
 * @version 	$Id: File.php 5152 2010-08-30 07:25:57Z mehrab $
 * @since		2.0.5
 */

class Multimedia_Models_Dao_Mysql_File extends Aman_Model_Dao
	...
	public function updateDescription($fileId, $title, $description = null) 
	{
		...
		if (null != $title) {
			...
			$updates[] = sprintf("slug = '%s'",
								mysql_real_escape_string(Aman_Utility_String::removeSign($title, '-', true)));
		}
		if (null != $description) {
