 ...
 * @version 	$Id: QuestionController.php 4930 2010-08-25 03:38:40Z mehrab $
 * @since		1.0.0
 */
...
class Poll_QuestionController extends Zend_Controller_Action 
{
	...
	public function activateAction() 
	{
		...
		if ($request->isPost()) {
			...
			$questionDao = Aman_Model_Dao_Factory::getInstance()->setModule('poll')->getQuestionDao();
	...
	public function addAction() 
	{
		...
		if ($request->isPost()) {
			...
			if ($answers != null && $questionId != null) {
				$answerDao = Aman_Model_Dao_Factory::getInstance()->setModule('poll')->getAnswerDao();
	...
	public function listAction() 
	{
		 ...
		 * Paginator
		 */
		$paginator = new Zend_Paginator(new Aman_Utility_PaginatorAdapter($questions, $numQuestions));
