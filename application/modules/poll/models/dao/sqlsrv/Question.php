 ...
 * @version 	$Id: Question.php 5057 2010-08-28 18:39:33Z mehrab $
 * @since		2.0.5
 */

class Poll_Models_Dao_Sqlsrv_Question extends Aman_Model_Dao
	implements Poll_Models_Interface_Question
{
	...
	public function getTranslations($item)
	{
		...
		$rows = $stmt->fetchAll();
		$stmt->closeCursor();
		return (null == $rows) ? null : new Aman_Model_RecordSet($rows, $this);
	}
