 ...
 * @version 	$Id: Widget.php 5207 2010-08-30 16:53:06Z mehrab $
 * @since		2.0.2
 */

class Tag_Widgets_TagCloud_Widget extends Aman_Widget 
{
	protected function _prepareShow() 
	{
		...
		$tagItemDao = Aman_Model_Dao_Factory::getInstance()->setModule('tag')->getTagItemDao();
		...
		if (count($keywords) > 0) {
			...
			Zend_Controller_Front::getInstance()->registerPlugin(new Aman_Controller_Plugin_PlaceHolder($className));
		}
