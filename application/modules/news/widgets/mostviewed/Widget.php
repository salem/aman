 ...
 * @version 	$Id: Widget.php 4714 2010-08-17 02:32:22Z mehrab $
 * @since		1.0.0
 */

class News_Widgets_MostViewed_Widget extends Aman_Widget 
{
	protected function _prepareShow() 
	{
		...
		$articleDao = Aman_Model_Dao_Factory::getInstance()->setWidget($this)->getArticleDao();
