 ...
 * @version 	$Id: RevisionController.php 4642 2010-08-15 16:09:28Z mehrab $
 * @since		2.0.4
 */
...
class News_RevisionController extends Zend_Controller_Action 
{
	...
	public function listAction()
	{
		 ...
		 * Paginator
		 */
		$paginator = new Zend_Paginator(new Aman_Utility_PaginatorAdapter($revisions, $numRevisions));
