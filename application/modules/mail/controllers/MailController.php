 ...
 * @version 	$Id: MailController.php 4522 2010-08-12 09:38:16Z mehrab $
 * @since		2.0.6
 */
...
class Mail_MailController extends Zend_Controller_Action
{
	...
	public function listAction()
	{
		...
		$mailDao = Aman_Model_Dao_Factory::getInstance()->setModule('mail')->getMailDao();
		 ...
		 * Paginator
		 */
		$paginator = new Zend_Paginator(new Aman_Utility_PaginatorAdapter($mails, $numMails));
	...
	public function sendAction()
	{
		...
		$conn = Aman_Db_Connection::factory()->getMasterConnection();
		$templateDao = Aman_Model_Dao_Factory::getInstance()->setModule('mail')->getTemplateDao();
