 ...
 * @version 	$Id: TemplateController.php 4539 2010-08-12 09:56:40Z mehrab $
 * @since		2.0.6
 */
...
class Mail_TemplateController extends Zend_Controller_Action
{
	...
	public function listAction()
	{
		 ...
		 * Paginator
		 */
		$paginator = new Zend_Paginator(new Aman_Utility_PaginatorAdapter($templates, $numTemplates));
