 ...
 * @version 	$Id: Widget.php 5394 2010-09-12 16:05:40Z mehrab $
 * @since		2.0.9
 */

class Utility_Widgets_WhoIsOnline_Widget extends Aman_Widget 
{
	...
	protected function _prepareShow() 
	{
		...
		$visitDao = Aman_Model_Dao_Factory::getInstance()->setWidget($this)->getVisitDao();
