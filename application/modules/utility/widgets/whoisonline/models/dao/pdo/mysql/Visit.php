 ...
 * @version 	$Id: Visit.php 5395 2010-09-12 17:03:03Z mehrab $
 * @since		2.0.9
 */

class Utility_Widgets_WhoIsOnline_Models_Dao_Pdo_Mysql_Visit extends Aman_Model_Dao
	implements Utility_Widgets_WhoIsOnline_Models_Interface_Visit
{
	...
	public function getOnlineUsers()
	{
		$rs = $this->_conn
					...
					->query()
					->fetchAll();
		return (null == $rs) ? null : new Aman_Model_RecordSet($rs, $this);
	}
}
