 ...
 * @version 	$Id: RequestLogger.php 3971 2010-07-25 10:26:42Z mehrab $
 * @since		1.0.0
 */
 ...
 * which procedured by Aman_Controller_Plugin_UrlCache plugin. 
 * If you don't want to log the request, set the flag <code>Aman_GlobalKey::LOG_REQUEST</code> 
...
class Core_Controllers_Plugin_RequestLogger extends Zend_Controller_Plugin_Abstract 
{
	...
	{
		if (Zend_Registry::isRegistered(Aman_GlobalKey::LOG_REQUEST) 
			&& Zend_Registry::get(Aman_GlobalKey::LOG_REQUEST) == false
		) {
			return;		
		}
		...
		$requestLogDao = Aman_Model_Dao_Factory::getInstance()->setModule('core')->getRequestLogDao();
