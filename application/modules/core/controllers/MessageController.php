 ...
 * @version 	$Id: MessageController.php 4107 2010-07-29 11:11:47Z mehrab $
 * @since		2.0.3
 */
...
class Core_MessageController extends Zend_Controller_Action 
{
	...
	public function init()
	{
		Zend_Layout::getMvcInstance()
			->setLayoutPath(AMAN_APP_DIR . DS . 'templates' . DS . 'admin' . DS . 'layouts')
			->setLayout('message');
	}
	...
	public function errorAction()
	{
        ...
        if (isset($config->install->version)) {
			...
			$logDao = Aman_Model_Dao_Factory::getInstance()->setModule('core')->getLogDao();
