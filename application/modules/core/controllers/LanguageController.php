 ...
 * @version 	$Id: LanguageController.php 3971 2010-07-25 10:26:42Z mehrab $
 * @since		1.0.0
 */
...
class Core_LanguageController extends Zend_Controller_Action 
{
	...
	public function addAction() 
	{
		...
		if ($request->isPost()) {
			...
			if ($section != '') {
				...
				$file = AMAN_APP_DIR . DS . 'modules' . DS . $module;
				$file = ($widget)
	...
	public function listAction() 
	{
		...
		foreach ($modules as $module) {
			$widgets[$module] = Aman_Utility_File::getSubDir(AMAN_APP_DIR . DS . 'modules' . DS . $module . DS . 'widgets');
		}
	...
	public function uploadAction()
	{
		...
		$request = $this->getRequest();
		if ($request->isPost()) {
			Aman_Language::upload($_FILES['file']);
			$this->_redirect($this->view->serverUrl() . $this->view->url(array(), 'core_language_list'));
		}
	}
}
