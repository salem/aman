 ...
 * @version 	$Id: Module.php 5336 2010-09-07 08:15:47Z mehrab $
 * @since		2.0.5
 */

class Core_Models_Dao_Pdo_Mysql_Module extends Aman_Model_Dao
	implements Core_Models_Interface_Module
{
	...
	{
		$file = AMAN_APP_DIR . DS . 'modules' . DS . $module . DS . 'config' . DS . 'about.xml';
		if (!file_exists($file)) {
			return null;
		}
