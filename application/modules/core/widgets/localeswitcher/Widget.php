 ...
 * @version 	$Id: Widget.php 5266 2010-08-31 11:25:20Z mehrab $
 * @since		1.0.1
 */

class Core_Widgets_LocaleSwitcher_Widget extends Aman_Widget 
{
	protected function _prepareShow()
	{
		$type = $this->_request->getParam('type', 'default');
		
		$config = Aman_Config::getConfig()->toArray();
		if ('false' == $config['localization']['enable']) {
			return;
		}
		
		/**
		 * Get base URL (http://localhost/amancms/index.php)
		 */
