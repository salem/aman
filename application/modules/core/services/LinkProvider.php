 ...
 * @version 	$Id: LinkProvider.php 4579 2010-08-12 19:13:03Z mehrab $
 * @since		2.0.7
 */
...
class Core_Services_LinkProvider
{
	 ...
	 * 
	 * @param string $lang The language (since 1.0.1)
	 * @return array
	 */
	public static function getLinks($lang = null)
	{
		...
		if (null == $lang) {
			$lang = Aman_Config::getConfig()->web->lang;
		}
		...
		$links = Aman_Hook_Registry::getInstance()->executeFilter('Core_LinkProvider', $links, array($lang));
