 ...
 * @version 	$Id: Privilege.php 3748 2010-07-17 11:48:19Z mehrab $
 * @since		2.0.3
 */

/**
 * Import all resources and previleges when user install AmanCMS
 */
class Core_Services_Install_Privilege
{
	...
	public function install($module) 
	{
		...
		$file = AMAN_APP_DIR . DS . 'modules' . DS . $module . DS . 'config' . DS . 'permissions.xml';
		if (!file_exists($file)) {
			return null;
		}
