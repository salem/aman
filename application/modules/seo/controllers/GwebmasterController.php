 ...
 * @version 	$Id: GwebmasterController.php 4823 2010-08-24 07:04:49Z mehrab $
 * @since		2.0.7
 */
...
class Seo_GwebmasterController extends Zend_Controller_Action
{
	...
	public function detailsAction()
	{
		 ...
		 */
		$currentUrl   = Aman_Config::getConfig()->web->url->base;
		...
		if ($request->isPost()) {
			...
			switch ($method) {
				...
				case 'metatag':
					 ...
					 */
					$file   = AMAN_APP_DIR . DS . 'modules' . DS . 'seo' . DS . 'config' . DS . 'config.ini';
