 ...
 * @version 	$Id: ToolkitController.php 4823 2010-08-24 07:04:49Z mehrab $
 * @since		2.0.7
 */
...
class Seo_ToolkitController extends Zend_Controller_Action
{
	...
	public function indexAction()
	{
		...
		$moduleConfig = Aman_Module_Config::getConfig('seo');
		$adapters = array(
			array(
				'searchEngine' => 'bing',
		...
		switch ($act) {
			 ...
			 */
			case 'rank':
				$googleRank = Aman_Seo_Rank_Google::getRank($url);
				$alexaRank  = Aman_Seo_Rank_Alexa::getRank($url);
				$result 	= array(
			...
			case 'indexed':
				...
				foreach ($adapters as $adapter) {
					...
					$toolkit      = Aman_Seo_Toolkit::factory($searchEngine);
					$toolkit->setUrl($url)
