 ...
 * @version 	$Id: Sitemap.php 3520 2010-07-10 11:29:01Z mehrab $
 * @since		2.0.7
 */

class Aman_Seo_Sitemap
{
	/**
	...
	public static function getItems($file)
	{
		...
		if (file_exists($file)) {
			...
			foreach ($xml->url as $url) {	
				$items[] = new Aman_Seo_Sitemap_Item(
					(string)$url->loc,
	 ...
	 *  
	 * @param string $file File name
	 * @param Aman_Seo_Sitemap_Item $item Sitemap item
	 * @return boolean
	 */
