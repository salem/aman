 ...
 * @version 	$Id: Google.php 3546 2010-07-11 07:42:17Z mehrab $
 * @since		2.0.7
 */
 ...
 */
class Aman_Seo_Toolkit_Google extends Aman_Seo_Toolkit_Abstract
{
	/**
	...
	public function getBackLinksCount()
	{
		...
		$content = Aman_Seo_Request::getResponse($url);
