 ...
 * @version 	$Id: ImageMagick.php 0001 2011-02-7 12:00:40Z mehrab $
 * @since		1.0.0
 */

class Aman_Image_ImageMagick extends Aman_Image_Abstract
{
	...
	public function flip($newFile, $mode)
	{
		...
		switch ($mode) {
			case Aman_Image_Abstract::FLIP_VERTICAL:
				$imagick->flipImage();
				break;
			case Aman_Image_Abstract::FLIP_HORIZONTAL:
				$imagick->flopImage();
				break;
		}
