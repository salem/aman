 ...
 * @version 	$Id: Widget.php 4636 2010-08-15 09:52:47Z mehrab $
 * @since		1.0.0
 */

abstract class Aman_Widget 
{
	/**
	 * @const string
	 * @since 2.0.3
	 */
	const CURRENT_WIDGET_KEY = 'Aman_Widget_CurrentWidgetKey';
	...
	public function __construct($module, $name) 
	{
		...
		$this->_view->addHelperPath(AMAN_APP_DIR . DS . 'modules' . DS . $this->_module . DS . 'views' . DS . 'helpers', 
									$this->_module.'_View_Helper_');
		$this->_view->addHelperPath(AMAN_APP_DIR . DS . 'modules' . DS . $this->_module . DS . 'widgets' . DS . $this->_name, 
	...
	public function __call($name, $arguments) 
	{
		...
		$path1 	  = AMAN_APP_DIR . DS . 'modules' . DS . $this->_module . DS . 'widgets' . DS . $this->_name;
		$path2 	  = AMAN_APP_DIR . DS . 'templates' . DS . $template . DS . 'views' . DS . $this->_module . DS . 'widgets' . DS . $this->_name;
