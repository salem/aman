 ...
 * @version 	$Id: Language.php 3867 2010-07-22 07:50:30Z mehrab $
 * @since		2.0.7
 */
...
class Aman_Language
{
	...
	public static function getAvailableLanguages()
	{
		...
		foreach ($modules as $module) {
			$moduleDir = AMAN_APP_DIR . DS . 'modules' . DS . $module . DS . 'languages';
	...
	public static function upload($file)
	{
		...
		foreach ($dirIterator as $file) {
            ...
            if ($file->isDir() && 'application' == $name) {
            	Aman_Utility_File::copyRescursiveDir($tempDir . DS . $name, AMAN_APP_DIR);
            }
        }
