 ...
 * @version 	$Id: Abstract.php 3762 2010-07-17 12:25:01Z mehrab $
 * @since		2.0.5
 */

abstract class Aman_Db_Connection_Abstract
{
	const KEY 		 = 'Aman_Db_Connection_Abstract_Key';
	const PREFIX_KEY = 'Aman_Db_Connection_Abstract_TablePrefix';
