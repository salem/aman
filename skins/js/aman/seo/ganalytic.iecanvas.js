 ...
 * @version 	$Id: ganalytic.iecanvas.js 5082 2010-08-29 12:07:45Z mehrab $
 * @since		2.0.7
 */

'Aman.Seo.Ganalytic.IECanvas.js'.namespace();
...
(function() {
	 ...
	 */
	function getContext() {
		//return this._context || (this._context = new Aman.Seo.Ganalytic.IECanvas(this));
		return new Aman.Seo.Ganalytic.IECanvas(this);
	};
 ...
 */
Aman.Seo.Ganalytic.IECanvas = function(element) {
...
Aman.Seo.Ganalytic.IECanvas.prototype.clearRect = function() {
	//$(this._element).html('');
	this._canvas.innerHtml = '';
};

Aman.Seo.Ganalytic.IECanvas.prototype.beginPath = function() {
	this._paths = [];
};

Aman.Seo.Ganalytic.IECanvas.prototype.moveTo = function(x, y) {
	var p = this._getCoordinates(x, y);
	this._paths.push({type: 'moveTo', x: p.x, y: p.y});
};

Aman.Seo.Ganalytic.IECanvas.prototype.lineTo = function(x, y) {
	var p = this._getCoordinates(x, y);
    this._paths.push({type: 'lineTo', x: p.x, y: p.y});
};

Aman.Seo.Ganalytic.IECanvas.prototype.closePath = function() {
	this._paths.push({ type: 'closePath'});
};

Aman.Seo.Ganalytic.IECanvas.prototype.fill = function() {
	this.stroke(true);
};
 ...
 * @return void
 */
Aman.Seo.Ganalytic.IECanvas.prototype.stroke = function(fill) {
	var output = [];
...
Aman.Seo.Ganalytic.IECanvas.prototype._getCoordinates = function(x, y) {
	var m = [
	            [1, 0, 0],
	            [0, 1, 0],
	            [0, 0, 1]
 ...
 * - alpha
 */
Aman.Seo.Ganalytic.IECanvas.prototype._normalizeStyle = function(color) {
	var str, alpha = 1;
 ...
 * @return string
 */
Aman.Seo.Ganalytic.IECanvas.prototype._normalizeLineCap = function(lineCap) {
	switch (lineCap) {
    	case 'butt':
    		return 'flat';
    	case 'round':
