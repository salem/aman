 ...
 * @version 	$Id: ganalytic.reporter.js 5082 2010-08-29 12:07:45Z mehrab $
 * @since		2.0.7
 */

'Aman.Seo.Ganalytic.Reporter.js'.namespace();
 ...
 * @constructor
 */
Aman.Seo.Ganalytic.Reporter = function(id, data) {
	/**
 ...
 * Setters
 */
Aman.Seo.Ganalytic.Reporter.prototype.enableTooltip = function(enable) { this._enableTooltip = enable; };
Aman.Seo.Ganalytic.Reporter.prototype.setTooltipPattern = function(pattern) { this._tooltipPattern = pattern; };
Aman.Seo.Ganalytic.Reporter.prototype.setFormatDimensionCallback = function(callback) { this._formatDimensionCallback = callback; };
Aman.Seo.Ganalytic.Reporter.prototype.setFormatMetricCallback = function(callback) { this._formatMetricCallback = callback; };
 ...
 * @return void
 */
Aman.Seo.Ganalytic.Reporter.prototype.show = function() {
 ...
 * @return float
 */
Aman.Seo.Ganalytic.Reporter.prototype._getMaxMetric = function() {
