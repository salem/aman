 ...
 * @version 	$Id: zone.js 5082 2010-08-29 12:07:45Z mehrab $
 * @since		1.0.0
 */
if(typeof AMAN === 'object'){
	AMAN.namespace('Aman.Ad.Zone');
	 ...
	 * @constructor
	 */
	Aman.Ad.Zone = function(id, name, width, height) {
		this._id 				 = id;
		this._name 				 = name;
		this._width 			 = width;
		this._height 			 = height;
		...
		this._mode 				 = Aman.Ad.Banner.UNIQUE_MODE;
	};
	
	Aman.Ad.Zone.prototype = {
		/**
		 * Getters/Setters
		 */
		...
		render: function() {
			...
			switch (this._mode) {
				case Aman.Ad.Banner.UNIQUE_MODE:
					var html = this._banners[0].render();
					$('#' + this._containerId).html(html);
					break;
				case Aman.Ad.Banner.SHARE_MODE:
					this._renderShareImageBanner();
					break;
				case Aman.Ad.Banner.ALTERNATE_MODE:
					var html = '';
					/**
