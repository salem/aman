 ...
 * @version 	$Id: banner.js 5082 2010-08-29 12:07:45Z mehrab $
 * @since		1.0.0
 */

if(typeof AMAN === 'object'){
	AMAN.namespace('Aman.Ad.Banner');
	 ...
	 * @constructor
	 */
	Aman.Ad.Banner = function(id, zone, options, baseUrl) {
		 ...
		 */
		Aman.Ad.Banner.UNIQUE_MODE 	= 'unique';
		Aman.Ad.Banner.SHARE_MODE 	= 'share';
		Aman.Ad.Banner.ALTERNATE_MODE = 'alternate';
	};
	
	Aman.Ad.Banner.prototype = {
		/**
		 * Getters/Setters
		 */
		...
		render: function() {
			switch (this._options['format']) {
				case 'image':
					 ...
					 */
					if (Aman.Ad.Banner.ALTERNATE_MODE == this._options['mode']) {
