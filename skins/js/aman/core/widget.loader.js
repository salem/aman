 ...
 * @version 	$Id: widget.loader.js 5352 2010-09-09 03:21:56Z mehrab $
 * @since		1.0.0
 */

if(typeof AMAN === 'object'){
	AMAN.namespace('Aman.Core.Widget.Loader');
	
	/**
	 * Aman.Core.Widget.Loader
	 * This class required plugins:
	 * - ajaxq
	 * - jquery.json
	 */
	Aman.Core.Widget.Loader = function() {};
	
	Aman.Core.Widget.Loader.baseUrl = '/';
	 ...
	 * @return void
	 */
	Aman.Core.Widget.Loader.queue = function(module, name, data, containerId, callback) {
		Aman.Core.Widget.Loader.queueAction(module, name, 'show', data, containerId, callback);
	};
	 ...
	 * @return void
	 */
	Aman.Core.Widget.Loader.queueAction = function(module, name, act, data, containerId, callback) {
		$('#' + containerId).addClass('loading').html('');
		var baseUrl = Aman.Core.Widget.Loader.baseUrl;
